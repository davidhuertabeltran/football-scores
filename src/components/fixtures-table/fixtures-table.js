	...
	return (
		<div className="fixtures-table flex flex-wrap gap-8 justify-evenly pt-6">
			{fixtures.map((fixture, index) => (
				<div onClick={() => navigate(`/fixture/${fixture.fixture.id}`)} key={index} className="card-fixture border-2 border-blue-200 w-[275px] rounded-md p-2 relative cursor-pointer flex flex-col justify-between" >
						...
						<div className="fixture-details w-full flex p-1 justify-evenly items-center">
							<div className="team-home-details flex justify-evenly items-center flex-col w-[33%] gap-2">
								...
								<div className="home-team-name">
									<p className="text-center text-xs">{fixture.teams.home.name}</p>
								</div>
							</div>
							...
							<div className="team-away-details flex justify-evenly items-center flex-col w-[33%] gap-2">
								...
								<div className="away-team-name">
									<p className="text-center text-xs">{fixture.teams.away.name}</p>
								</div>
							</div>
						</div>
